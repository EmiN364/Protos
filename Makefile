...
SMTPD_CLI:= smtpd
MNG_CLI:= mng_client
SMTPD_OBJECTS:= args.o selector.o main.o smtp.o stm.o buffer.o request.o data.o udpServer.o
...
clean:
	- rm -f $(SMTPD_CLI) *.o request_test $(MNG_CLI) $(MNG_SERV)
